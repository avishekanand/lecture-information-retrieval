...
\node[box=hybrid!15, right=3.5cm of enc] (idx) {ANN Index\\(refreshed every __MATH_INLINE_0__ steps)};
\node[box=dense!15, below=1.5cm of __MATH_INLINE_1__] (neg) {Hard Negatives\\(top-__MATH_INLINE_2__ from stale index)};
