\begin{tikzpicture}[scale=0.5, every node/.style={scale=0.5}]
    ...
    % Sparse Connections
    \IRArrowPath{text.north}{tokens.west}{Sparse Pipeline}
    \IRArrow{tokens}{ids}{}
    \IRArrow{ids}{sindex}{}
    \IRArrowPath{sindex.east}{res.north}{}
    
    % Dense Connections
    \IRArrowPath{text.south}{mtoken.west}{Dense Pipeline}
    \IRArrow{mtoken}{embed}{}
    \IRArrow{embed}{dindex}{}
    \IRArrowPath{dindex.east}{res.south}{}
\end{tikzpicture}
