\begin{tikzpicture}[
  box/.style={draw, rounded corners, thick, align=center, font=\small, minimum width=3.2cm, minimum height=0.8cm},
...
\draw[arr, rounded corners] (eval.south) -- ++(0,-0.4) -| ++(-4.8,0) |- (idx.west) node[pos=0.25, font=\scriptsize, left] {tuning};
\end{tikzpicture}
