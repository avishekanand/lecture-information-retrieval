...
\node[box, fill=irSparse!15, right=2.1cm of user] (retr) {Retrieve\\(sparse/dense/hybrid)};
\node[box, fill=irHybrid!15, right=2.1cm of retr] (cond) {Condition\\(prompt/context)};
\node[box, fill=irRerank!15, right=2.1cm of cond] (gen) {Generate\\(LLM reasoning)};
...
\draw[arr] (gen) -- ++(1.2,0) node[right, font=\small] {Answer + citations};
