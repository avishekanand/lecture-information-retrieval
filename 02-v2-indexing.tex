...
\begin{frame}[shrink=10]{Inverted Index: Core Structure}
\textbf{Documents:}
\begin{itemize}
...
\begin{frame}{Inverted Index as a Sparse Matrix}
...
\begin{frame}[shrink=15]{Text Preprocessing Pipeline}
