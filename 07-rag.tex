...
\vspace{0.7em}
\cpause
\begin{alertblock}{RAG = Parametric + Non-Parametric}
...
\vspace{0.7em}
\cpause
\begin{alertblock}{Both are required}
...
\end{column}
\begin{column}{0.44\textwidth}
\begin{alertblock}{The Scale Paradox}
\small
...
\vspace{0.6em}
\cpause
\begin{alertblock}{Retrieval defines the reasoning substrate}
...
\end{column}
\begin{column}{0.42\textwidth}
\begin{alertblock}{Practical default (2025)}
\small
...
\begin{alertblock}{Cost Trade-off}
\small
...
\end{column}
\begin{column}{0.48\textwidth}
\begin{alertblock}{What you don't get}
\begin{itemize}
