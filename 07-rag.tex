...
\begin{frame}{Why Closed-Book QA Falls Short}
% \irStage{LIMITATIONS}
...
There is no ``ground truth'' signal during autoregressive generation.
...
\midrule
Extractive      & Question + passage  & Span in passage       & SQuAD, NewsQA \\
Abstractive     & Question + passage  & Generated string      & NarrativeQA, CoQA \\
Open-Domain     & Question only       & Answer (from corpus)  & Natural Questions, TriviaQA \\
Knowledge-Base  & Question + KG       & Entity/relation       & WebQuestions, LC-QuAD \\
Conversational  & Multi-turn history  & Answer in context     & QuAC, DoQA \\
\bottomrule
\end{tabular}
}
\end{table}
...
Question: \emph{What is the most common form of transport on roads in Germany?}
...
\begin{frame}[shrink=5]{Original RAG Architecture (Lewis et al.\ 2020)}
% \irStage{ARCHITECTURE}
\begin{center}
\fbox{\includegraphics[width=0.8\textwidth]{figures/rag-original.pdf}}
\end{center}
...
\begin{itemize}
  ...
  \item ``When did this city host the Olympics given this image ?'' \hfill (text + image context)
...
% ====================================================================
\section{Part 6 --- Evaluation (again) and Summary}
% ====================================================================
