...
% ====================================================================
\section{Part 4 --- Complex Queries}
% ====================================================================
...
% \begin{frame}[shrink=10]{Query Reformulation: Aligning Questions with Evidence}
% \textbf{Before decomposing, we may need to rewrite the query itself.}

% \vspace{0.8em}
% \begin{block}{Reformulation strategies}
% \begin{itemize}
%   \item \textbf{HyDE}: generate a hypothetical answer document, embed it
%   \item \textbf{Multi-query}: generate paraphrases, retrieve for each, fuse
%   \item \textbf{Step-back}: rewrite to a more general conceptual question
%   \item \textbf{Decomposition}: split a complex query into smaller sub-queries
% \end{itemize}
% \end{block}

% \cpause
% \begin{block}{Risk: intent drift}
% Reformulation may move away from the user's true information need.
% Always compare results from the original and rewritten query.
% \end{block}
% \end{frame}
...
% \begin{frame}{Chain-of-Thought Query Decomposition}
