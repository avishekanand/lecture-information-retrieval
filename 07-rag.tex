...
\begin{frame}{What are the conditioning decisions that need to be made?}
% \irStage{SYSTEM ARCHITECTURE}
\begin{center}
\resizebox{1.0\textwidth}{!}{
\input{tikz/rag_system_view_simple_condition.tex}
}
\end{center}
\end{frame}

\begin{frame}{What are the generation decisions that need to be made?}
% \irStage{SYSTEM ARCHITECTURE}
\begin{center}
\resizebox{1.0\textwidth}{!}{
\input{tikz/rag_system_view_simple_generate.tex}
}
\end{center}
\end{frame}

\begin{frame}{RAG Decisions: A Holistic View}
% \irStage{SYSTEM ARCHITECTURE}
\begin{center}
