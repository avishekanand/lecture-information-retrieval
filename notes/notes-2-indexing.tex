...
\begin{center}
\input{tikz/retrieval_reasoning_standalone.tex}
\end{center}
...
\begin{center}
\input{tikz/traditional_search.tex}
\end{center}
...
\centering
\input{tikz/old_interface.tex}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
\centering
\input{tikz/modern_interface.tex}
\end{minipage}
\end{center}
\end{center}
...
The \emph{recall ceiling} of an indexing system is the maximum recall achievable by any downstream component. If a relevant document is not returned by the candidate generation stage, no re-ranker or LLM can recover it~\cite{robertson2009probabilistic}.

\begin{center}
\input{tikz/indexing_controls.tex}
\end{center}
...
\begin{center}
\input{tikz/inverted_index_structure.tex}
\end{center}
...
\begin{center}
\input{tikz/score_aggregation.tex}
\end{center}
...
\begin{center}
\input{tikz/preprocessing_pipeline.tex}
\end{center}
...
\begin{center}
\input{tikz/wordpiece_example.tex}
\end{center}
...
\begin{center}
\input{tikz/accuracy_speed_tradeoff.tex}
\end{center}
...
\begin{center}
\input{tikz/vector_projection.tex}
\end{center}
