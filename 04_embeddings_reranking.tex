...
\begin{center}
\input{tikz/embedding_matrix.tex}
\end{center}\cpause
...
\vspace{0.5em}
\begin{center}
\input{tikz/self_attention_logic.tex}
\end{center}
...
\begin{column}{0.5\textwidth}
\begin{center}
\input{tikz/bert_cls_aggregation.tex}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
\begin{center}
\input{tikz/bert_token_representations.tex}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Cross-Encoder or MonoBERT: BERT for Re-ranking}
% \irStage{RE-RANKING}
