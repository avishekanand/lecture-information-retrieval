...
\textbf{Recall}: Sparse methods (BM25) find $\sim$1000 candidates quickly.
\textbf{Precision}: Dense methods (Cross-Encoders) re-rank the top candidates.
\textbf{Scaling}: Enables web-scale search at sub-second latencies.\cpause
