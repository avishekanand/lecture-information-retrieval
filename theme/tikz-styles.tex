...
\definecolor{irAccent}{HTML}{E74C3C}   % Accent: Bright Red (same as irRerank)
\definecolor{irPrimary}{HTML}{3498DB}  % Primary: Blue (same as irSparse)
\definecolor{irSecondary}{HTML}{E67E22} % Secondary: Orange (same as irDense)

\definecolor{irPointwise}{HTML}{3498DB} % Derived from v0
\definecolor{irPairwise}{HTML}{E74C3C}  % Derived from v0
\definecolor{irListwise}{HTML}{1ABC9C}  % Derived from v0
...
\tikzset{
    ...
    info/.style={font=\scriptsize\itshape, text=gray},
