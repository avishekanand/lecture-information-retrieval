...
% Title information
\title[Embeddings \& Neural Ranking]{Lecture 4: Embeddings and Neural Ranking}
\subtitle{From Word2Vec to Transformers}
...
\begin{enumerate}
    ...
    \item \textbf{Embeddings \& Transformer-based Re-rankers} $\leftarrow$ Today
...
\vspace{1em}
\textbf{Today's Goal:} Transition from keyword matching to \textbf{semantic matching} using neural representations.
\end{frame}
