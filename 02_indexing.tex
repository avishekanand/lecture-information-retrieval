...
\begin{enumerate}
    \item \textbf{Inverted Index Posting Lists}
    \begin{itemize}
        \item Structure and formats
        \item Skip lists and optimizations
    \end{itemize}
    \pause
    
    \item \textbf{Query Processing Algorithms}
    \begin{itemize}
        \item Document-at-a-time (DAAT)
        \item Term-at-a-time (TAAT)
        \item Optimizations and early termination
    \end{itemize}
    \pause
    
    \item \textbf{Index Compression}
    \begin{itemize}
        \item Gap encoding
        \item Variable-byte, Gamma, PForDelta
        \item Trade-offs
    \end{itemize}
    \pause
    
    \item \textbf{Approximate k-NN Indexing}
    \begin{itemize}
        \item HNSW, IVF, Product Quantization
        \item Dense retrieval for neural search
    \end{itemize}
\end{enumerate}
\end{frame}
