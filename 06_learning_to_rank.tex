...
\begin{enumerate}
    ...
    \item Dense Retrieval \checkmark
    \item \textbf{Learning to Rank} $\leftarrow$ Today
\end{enumerate}

\vspace{1em}
\textbf{Today's Goal:} Learn how to combine multiple retrieval signals into a single, optimized ranker.
\end{frame}
...
\begin{itemize}
    ...
    \item \textbf{Optimization:} Learning to Rank to combine it all.
\end{itemize}
