...
\begin{center}
\fbox{\includegraphics[width=0.92\linewidth,height=4.3cm,keepaspectratio]{figures/search_amazon.png}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=0.92\linewidth,height=4.3cm,keepaspectratio]{figures/scholar.pdf}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=0.92\linewidth,height=4.3cm,keepaspectratio]{figures/netflix-2.pdf}}
\end{center}
...
\begin{center}
\fbox{\includegraphics[width=0.92\linewidth,height=4.3cm,keepaspectratio]{figures/ads.pdf}}
\end{center}
...
\vspace{1.5em}
\alert{In this lecture, we shift focus to the most powerful of these: the Listwise approach.}
\end{frame}
