...
\begin{center}
\input{tikz/infonce_classification.tex}
\end{center}
...
\begin{center}
\input{tikz/infonce_batch_approx.tex}
\end{center}
...
\begin{center}
\input{tikz/hard_negatives_viz.tex}
\end{center}
\end{frame}
...
\begin{frame}[shrink=20]{The Evolving Encoder: Representations Shift Over Training}
\begin{center}
\input{tikz/evolving_encoder.tex}
\end{center}
...
\begin{frame}[fragile,shrink=10]{ANCE: Asynchronous Index Refresh}
...
\begin{center}
\input{tikz/contriever_training.tex}
\end{center}
\end{frame}

\begin{frame}[shrink=5]{Why Contriever Works (and What It Does Not Fix)}
\begin{columns}[T]
...
\begin{center}
\input{tikz/rrf_visualization.tex}
\end{center}
...
\begin{frame}[fragile,shrink=10]{The Complete Modern Retrieval Stack}
\begin{center}
\begin{tikzpicture}[
...
\normalsize
\vspace{1em}
\textbf{Preview:} Next class we learn about \textbf{Learning to Rank}.
\end{center}
\end{frame}
