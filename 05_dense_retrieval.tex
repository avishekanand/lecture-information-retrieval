...
\textbf{We need Hard Negative Mining strategy that adapts to the encoder's current capability.}
...
\begin{itemize}
    \item Uses unsupervised contrastive pre-training on diverse Web data.
    \item Does \textbf{not} require manual relevance labels for the first stage.
    \item Learns robust semantic representations that generalize across domains.
\end{itemize}
\end{block}
