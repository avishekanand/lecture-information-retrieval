...
### [Lecture 1: Vector Space Model & Boolean Retrieval](done/01_intro_vector_space.tex)
...
### [Lecture 2: Sparse and Dense Indexing](done/02_indexing.tex)
...
### [Lecture 3: Sparse Ranking Methods](done/03_ranking.tex)
...
### [Lecture 4: Representation Learning for Rankings](done/04_embeddings_reranking.tex)
...
### [Lecture 5: Dense Retrieval --- From Bi-Encoders to Late Interaction](done/05_dense_retrieval.tex)
...
### [Lecture 6: Learning to Rank (LTR)](done/06_ltr.tex)
...
### [Lecture 7: Question Answering and Retrieval-Augmented Generation (RAG)](07-rag.tex)
...
---
© 2024-2025 Avishek Anand. All rights reserved.
